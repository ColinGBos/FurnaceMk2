...
public class Registration {
    ...
    public static final RegistryObject<Item> FURNACEMK2_ITEM = ITEMS.register("furnacemk2", () -> new BlockItem(FURNACEMK2_BLOCK.get(), new Item.Properties().tab(ModSetup.ITEM_GROUP)));
