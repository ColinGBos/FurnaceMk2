...
public class ConfigSettings {
    ...
    private static void setupFirstBlockConfig(ForgeConfigSpec.Builder SERVER_BUILDER, ForgeConfigSpec.Builder CLIENT_BUILDER) {
        ...
        FURNACE_BASE_EFFICIENCY = SERVER_BUILDER.comment("Base efficiency multiplier for the FurnaceMk2").defineInRange("furnaceBaseEfficiency", 1.0, 0.5, 10.0);
        FURNACE_BASE_EXPERIENCE = SERVER_BUILDER.comment("Base experience multiplier for the FurnaceMk2").defineInRange("furnaceBaseExperience", 1.0, 0.5, 10.0);
        FURNACE_BASE_SPEED = SERVER_BUILDER.comment("Base speed multiplier for the FurnaceMk2").defineInRange("furnaceBaseSpeed", 1.0, 0.0, 10.0);
