...
//    }
    ...
    @Override
    public void registerRecipes(IRecipeRegistration registration) {
        registration.addIngredientInfo(new ItemStack(Registration.FURNACEMK2_ITEM.get()), VanillaTypes.ITEM_STACK, Component.translatable("furnacemk2.furnacemk2.jei_info"));
    }
}
